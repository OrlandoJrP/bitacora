 ...
 * - jul-2026 va como porcentaje +6.6 con en_curso = true (flotante).
...
export const FONDO = {
  nombre: "Fondo Compartido",
  fechaInicio: "2024-09-01",
  capitalInicial: "6125.00", // semilla (Lenin)
  comisionPct: "35.000",
  baseComision: "ganancia_neta" as const,
  notas: "Importado del Excel REPORTE_FONDO_JUL2026 (corte 09/07/2026).",
};
...
export const RENDIMIENTOS: RendHistorico[] = [
  ...
  { anio: 2026, mes: 7, modo: "porcentaje", valor: "6.6", enCurso: true, descripcion: "Mes en curso al 09/07/2026: resultado flotante" },
];
...
export const ESPERADO: EsperadoMes[] = [
  ...
  { anio: 2026, mes: 7, fondo: 82294.16, LENIN: 16457.4, ARLET: 65836.76, RAILEN: 0 },
];

/** TWR desde el inicio esperado (RESUMEN del Excel), en %, con el flotante. */
export const TWR_ESPERADO_PCT = 181.07;
export const TWR_2026_ESPERADO_PCT = 7.93;
